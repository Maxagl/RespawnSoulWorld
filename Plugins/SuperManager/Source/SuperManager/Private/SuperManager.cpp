...
void FSuperManagerModule::InitCustomSelectionEvent()
{
	...
	// 被动监听，gpt的说法是可以遍历selection，找到选择的内容
...
TSharedRef<class ISceneOutlinerColumn> FSuperManagerModule::OnCreateSelectionLockColumn(ISceneOutliner& SceneOutliner)
{
