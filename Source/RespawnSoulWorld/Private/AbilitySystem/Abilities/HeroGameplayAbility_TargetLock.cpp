...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor ||
		URswFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, RswGameplayTags::Shared_Status_Dead) ||
		URswFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), RswGameplayTags::Shared_Status_Dead)
		)
	{
	...
	const bool bShouldOverrideRotation =
		!URswFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), RswGameplayTags::Player_Status_Rolling)
		&&
		!URswFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), RswGameplayTags::Player_Status_Blocking);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if (InSwitchDirectionTag == RswGameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	if (!DrawnTargetLockWidget)
	{
		...
		DrawnTargetLockWidget = CreateWidget<URswWidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
...
void UHeroGameplayAbility_TargetLock::SetTargetLockWidgetPosition()
{
	...
	// controller 是用来判断透视的基准点，简单的来说是谁来看形成的屏幕坐标
...
{
	// 结束游戏会导致controller直接没了, editor会报错。所以提前返回
