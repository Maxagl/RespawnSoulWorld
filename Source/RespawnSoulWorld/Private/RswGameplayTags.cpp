...
namespace RswGameplayTags
{
    ...
    UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialCharacterAbility_Charge, "InputTag.SpecialCharacterAbility.Charge");
    UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialCharacterAbility_Charge_RingOfGustBurst, "InputTag.SpecialCharacterAbility.Charge.RingOfGustBurst");
    ...
    UE_DEFINE_GAMEPLAY_TAG(InputTag_UseCampFire, "InputTag.UseCampFire");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Ability_SpecialWeaponAbility_Charge_RingOfGustBurst, "Player.Ability.SpecialWeaponAbility.Charge.RingOfGustBurst");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_RingGust, "Player.Cooldown.RingGust");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Event_Released_ChargeKey, "Player.Event.Released.ChargeKey");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Status_CombatMode, "Player.Status.CombatMode");
    UE_DEFINE_GAMEPLAY_TAG(Player_Status_State_ChargingWind, "Player.Status.State.ChargingWind");
    UE_DEFINE_GAMEPLAY_TAG(Player_Status_State_GustActive, "Player.Status.State.GustActive");
    UE_DEFINE_GAMEPLAY_TAG(Player_Status_Buff_WindMastery, "Player.Status.Buff.WindMastery");


    UE_DEFINE_GAMEPLAY_TAG(Player_SetByCaller_AttackType_Light, "Player.SetByCaller.AttackType.Light");
    UE_DEFINE_GAMEPLAY_TAG(Player_SetByCaller_AttackType_Heavy, "Player.SetByCaller.AttackType.Heavy");
    UE_DEFINE_GAMEPLAY_TAG(Player_SetByCaller_AttackType_Magic_Wind, "Player.SetByCaller.AttackType.Magic.Wind");

    UE_DEFINE_GAMEPLAY_TAG(Player_SetByCaller_CoolDownDuration_RingOfGust, "Player.SetByCaller.CoolDownDuration.RingOfGust");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Enemy_Boss_Ability_DrawWidget, "Enemy.Boss.Ability.DrawWidget");
    UE_DEFINE_GAMEPLAY_TAG(Enemy_Boss_Event_EnterFogDoor, "Enemy.Boss.Event.EnterFogDoor");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Shared_Event_AnimationEnd, "Shared.Event.AnimationEnd");

    UE_DEFINE_GAMEPLAY_TAG(Shared_SetByCaller_BaseDamage, "Shared.SetByCaller.BaseDamage");
    UE_DEFINE_GAMEPLAY_TAG(Shared_SetByCaller_Buff_WindMastery, "Shared.SetByCaller.Buff.WindMastery");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Shared_Status_IsUsed, "Shared.Status.IsUsed");
    UE_DEFINE_GAMEPLAY_TAG(Shared_Environment_LightObject, "Shared.Environment.LightObject");
    UE_DEFINE_GAMEPLAY_TAG(Shared_Environment_MediumObject, "Shared.Environment.MediumObject");
