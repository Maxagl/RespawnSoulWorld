...
#include "RswWidget_ConfirmScreen.generated.h"
...
UCLASS()
class RESPAWNSOULWORLD_API UConfirmScreenInfoObject : public UObject
{
	GENERATED_BODY()
...
class RESPAWNSOULWORLD_API URswWidget_ConfirmScreen : public URswActivatableWidgetBase
{
	GENERATED_BODY()
public:
