...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "Rsw|Ability")
    FGameplayEffectSpecHandle MakeHeroMagicDamageEffectSpecHandle(TSubclassOf<UGameplayEffect> EffectClass, float InWeaponBaseDamage, FGameplayTag InCurrentAttackTypeTag, float BufferMagnitued);
